...
class UserAdmin(BaseUserAdmin):
    ...
    'trade_progress','trade_profit', 'profile_image', 'trade_platform'
,'trade_account', 'trade_complete','trade_complete_message','trade_bonus','phone','verify_otp', 'email_not_verified','withdraw_not_eligable','bronze','silver','gold','platinum','show_message','user_message','user_button_text','place_on_hold','enable_error_sound','enable_photo_upload','photo_upload_error_message')
    search_fields = ('email',)
    ...
    'trade_progress','trade_profit','profile_image','trade_complete','trade_complete_message','trade_bonus','phone', 'verify_otp','email_not_verified','withdraw_not_eligable','bronze', 'silver','gold','platinum','show_message','user_message','user_button_text','place_on_hold','enable_error_sound','enable_photo_upload','photo_upload_error_message')}),
    ...
    add_fieldsets = (
        ...
        ('Personal info',{'fields':('first_name','last_name','account_level','deposit_amount',
    'trade_progress','trade_profit','profile_image', 'trade_platform'
,'trade_account','trade_complete','trade_complete_message','trade_bonus','phone','verify_otp','email_not_verified','withdraw_not_eligable','bronze','gold','platinum','show_message','user_message','user_button_text','place_on_hold','enable_error_sound','enable_photo_upload','photo_upload_error_message')}),
...
class Account_levelAdmin(admin.ModelAdmin):
    list_display = ('bronze_min','bronze_max','bronze_duration','bronze_profit','silver_min','silver_max','silver_duration','silver_profit','gold_min','gold_max','gold_duration','gold_profit','platinum_min','platinum_max','platinum_duration','platinum_profit')
